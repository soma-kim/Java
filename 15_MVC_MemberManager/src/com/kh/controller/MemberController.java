...
for(int i = 0; i < list.size(); i++) {
	...
	public int insertMember(String userId, String userPwd, String userName, int age, char gender, String email, String phone) {
		...
		for(int i = 0; i < list.size(); i++) {
			userNo = list.get(i).getUserNo();
		}
		}
		realUserNo = userNo + 1;
		
		list.add(new Member(realUserNo, userId, userPwd, userName, age, gender, email, phone));
	...
	public ArrayList<Member> searchMemberByName(String userName) {
